...
extern int strayDataAlloc();
extern int strayDataFree();
extern void setRainWallParams(int rainwall_cnt, int rainwall_dist);
extern int strayProcPva(std::string& exception_msg, int32_t& status_code,
