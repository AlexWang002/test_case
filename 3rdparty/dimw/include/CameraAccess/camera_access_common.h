...
#define SENSOR_ID_DEF(offset)      (1U << (offset - 1))
#define SENSOR_FRONT_LEFT_RADAR    SENSOR_ID_DEF(1U)
#define SENSOR_FRONT_RIGHT_RADAR   SENSOR_ID_DEF(2U)
#define SENSOR_REAR_LEFT_RADAR     SENSOR_ID_DEF(3U)
#define SENSOR_REAR_RIGHT_RADAR    SENSOR_ID_DEF(4U)
#define SENSOR_FRONT_RADAR_SLAVE       SENSOR_ID_DEF(5U)
#define SENSOR_FRONT_RADAR_MASTER       SENSOR_ID_DEF(6U)
#define SENSOR_MIDDLE_LIDAR        SENSOR_ID_DEF(7U)
#define SENSOR_LEFT_LIDAR          SENSOR_ID_DEF(8U)
#define SENSOR_RIGHT_LIDAR         SENSOR_ID_DEF(9U)
